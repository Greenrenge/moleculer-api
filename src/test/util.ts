...
let i = 0;
export function getServiceBroker(props?: { logger?: getLoggerProps; delegator?: ServiceBrokerDelegatorConstructorOptions }) {
...
export function getSchemaRegistry(props?: { logger?: getLoggerProps; delegator?: ServiceBrokerDelegatorConstructorOptions; opts?: RecursivePartial<SchemaRegistryOptions> }) {
...
export function getAPIServer(props?: { logger?: getLoggerProps; schema?: SchemaRegistry; opts?: RecursivePartial<APIServerOptions> }) {
