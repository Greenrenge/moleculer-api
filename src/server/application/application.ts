...
import { Route, BranchHandlerMap, RouteHandlerMap, ServerApplicationComponent, ServerApplicationComponentConstructorOptions, ServerApplicationComponentConstructors, ServerApplicationComponentModules } from "./component";
...
export class ServerApplication {
  ...
  constructor(
    ...
    opts?: RecursivePartial<ServerApplicationOptions>,
  ) {
          ...
          .acquire(component.key, () => {
            ...
            for (const version of newVersions) {
              if (!versionHandlerMap.has(version)) {
                ...
                const routes = [...version.routes, ...this.staticRoutes].filter(component.canHandleRoute.bind(component));
